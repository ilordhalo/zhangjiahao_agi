...
> Historical document: the external embedded/global Symphony runtime described below was removed in Symphonz 0.3.1. The CLI now supports only its built-in service.
